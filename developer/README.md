...
_This guide assumes basic setup has been performed on the Mac._ 
...
To setup Mac for terminal that is more useful and pretty, refer to _"terminal"_ setup guide
